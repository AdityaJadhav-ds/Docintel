"""Rewrites backend_v2/main.py — pure OCR pipeline, NO database, NO SQLite."""
import pathlib

MAIN_PY = pathlib.Path(r"z:\doc-validator 2\doc-validator\backend_v2\main.py")
...
print(f"backend_v2/main.py rewritten — {lines} lines. SQLite removed.")
